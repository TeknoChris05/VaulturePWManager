...
class AccountFrame(customtkinter.CTkFrame):
    def __init__(self, master, parent):
        ...
        info_frame = customtkinter.CTkFrame(self, fg_color="#23272A", corner_radius=10)
        info_frame.pack(pady=10, padx=10, fill="x")

        self.text_widget = customtkinter.CTkTextbox(info_frame, height=200, width=600, font=("Arial", 16))
        self.text_widget.pack(pady=10, padx=10)
        self.load_Account_Info()

        Erase_button = customtkinter.CTkButton(
            self, text="Erase Account?", fg_color="#FF4C4C",
            hover_color="#FF6666", text_color="white",
            corner_radius=10, border_width=2, border_color="#FF6666",
            width=60, height=70, command=self.confirm_erase
        )
