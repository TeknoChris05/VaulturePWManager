...
hamburger_button = customtkinter.CTkButton(main_frame, text="☰", width=60, height=60, corner_radius=10,
                                           fg_color="#0e3161", border_width=2, border_color="gray",
                                           command=lambda: toggle_sidebar())
hamburger_button.grid(row=0, column=0, padx=20, pady=30)

filter1_button = customtkinter.CTkButton(sidebar, text="Passwords🔒", width=150, height=20, corner_radius=5,
...
filter3_button = customtkinter.CTkButton(sidebar, text="Notes📝", width=150, height=20, corner_radius=5,
                                         fg_color="#282929", border_width=2, border_color="gray",
...
filter5_button = customtkinter.CTkButton(sidebar, text="One-Time Password🔐", width=150, height=20, corner_radius=5,
                                         fg_color="#282929", border_width=2, border_color="gray",
                                         command=lambda: open_one_time_password_page())
filter5_button.grid(row=3, column=0, padx=30, pady=10, sticky="nsew")

Archive_button = customtkinter.CTkButton(sidebar, text="Archived 📦", width=40, height=20, corner_radius=5,
                                         fg_color="#282929", border_width=2, border_color="gray",
                                         command=lambda: open_archive_page())
Archive_button.grid(row=4, column=0, padx=30, pady=20, sticky="nsew")

Trash_button = customtkinter.CTkButton(sidebar, text="Trash 🗑️", width=40, height=20, corner_radius=5,
                                       fg_color="#282929", border_width=2, border_color="gray")
...
ValtureP_button = customtkinter.CTkButton(bottom_bar, text="🐦", width=60, height=70, corner_radius=900,
                                          fg_color="#282929", border_width=2, border_color="gray",
...
Search_button = customtkinter.CTkButton(bottom_bar, text="⭐", width=60, height=70, corner_radius=900,
                                        fg_color="#282929", border_width=2, border_color="gray",
                                        command=lambda: open_favorites_page())
Search_button.grid(row=0, column=1, pady=5)

# Profile button in bottom bar
Profile_button = customtkinter.CTkButton(bottom_bar, text="👥", width=60, height=70, corner_radius=900,
                                         fg_color="#282929", border_width=2, border_color="gray",
...
Settings_button = customtkinter.CTkButton(bottom_bar, text="⚙️", width=10, height=70, corner_radius=900,
...
def open_passwordMaker_page(*args, **kwargs):
    ...
    Username_Entry = customtkinter.CTkEntry(Border_Frame, placeholder_text="Enter Username")
    Username_Entry.grid(row=2, column=2, pady=10, sticky="ew")

    label = customtkinter.CTkLabel(Border_Frame, text="Email", text_color="black")
    label.grid(row=3, column=2, pady=10, sticky="ew")

    Email_Entry = customtkinter.CTkEntry(Border_Frame, placeholder_text="Enter Email")
    Email_Entry.grid(row=4, column=2, pady=10, sticky="ew")

    label = customtkinter.CTkLabel(Border_Frame, text="Password", text_color="black")
    label.grid(row=5, column=2, pady=10, sticky="ew")

    Password_Entry = customtkinter.CTkEntry(Border_Frame, placeholder_text="Enter Password")
    Password_Entry.grid(row=6, column=2, pady=10, sticky="ew")
    ...
    customtkinter.CTkCheckBox(Border_Frame, text="Special Characters", variable=use_special, text_color="black").grid(
        row=8, column=2, pady=5, sticky="ew")
    customtkinter.CTkCheckBox(Border_Frame, text="Numbers", variable=use_numbers, text_color="black").grid(row=9,
                                                                                                           column=2,
                                                                                                           pady=5,
                                                                                                           sticky="ew")
    customtkinter.CTkCheckBox(Border_Frame, text="Uppercase Letters", variable=use_upper, text_color="black").grid(
        row=8, column=3, pady=5, sticky="ew")
    customtkinter.CTkCheckBox(Border_Frame, text="Lowercase Letters", variable=use_lower, text_color="black").grid(
        row=9, column=3, pady=5, sticky="ew")
    ...
    customtkinter.CTkButton(Border_Frame, text="Generate Password", command=generate_password).grid(row=10, column=2,
                                                                                                    pady=10,
                                                                                                    sticky="ew")
    #######################################################################################################################################################
    ...
    # Save Button
    create_button = customtkinter.CTkButton(Border_Frame, text="Create",  command=store_password_data)
...
def open_one_time_password_page():
    ...
    label = customtkinter.CTkLabel(Border_Frame, text="One-Time Password Maker", font=("Verdana", 20),
                                   text_color="black")
    label.pack(pady=20)
...
def open_Profile_Page():
    ...
    if "Profile_Frame" not in globals():
        ...
        name_entry = customtkinter.CTkEntry(Border_Frame, textvariable=Profile_Name, width=250,
